...
void SpaceDefanseGameImpl::Render()
{
...
void SpaceDefanseGameImpl::SetColor(D2D1_COLOR_F color)
{
    m_brush->SetColor(color);
}

void SpaceDefanseGameImpl::FillRect(D2D1_RECT_F rect, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->FillRectangle(rect, m_brush.Get());
}

void SpaceDefanseGameImpl::StrokeRect(D2D1_RECT_F rect, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawRectangle(rect, m_brush.Get(), width);
}

D2D1_RECT_F SpaceDefanseGameImpl::FullViewportRect() const
{
    if (!m_renderTarget)
    {
...
void SpaceDefanseGameImpl::FillViewport(D2D1_COLOR_F color)
{
    if (!m_renderTarget)
    {
        return;
...
void SpaceDefanseGameImpl::FillRoundRect(D2D1_RECT_F rect, float radius, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->FillRoundedRectangle(D2D1::RoundedRect(rect, radius, radius), m_brush.Get());
}

void SpaceDefanseGameImpl::StrokeRoundRect(D2D1_RECT_F rect, float radius, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawRoundedRectangle(D2D1::RoundedRect(rect, radius, radius), m_brush.Get(), width);
}

void SpaceDefanseGameImpl::FillEllipse(Vec2 pos, float rx, float ry, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->FillEllipse(Ellipse(pos, rx, ry), m_brush.Get());
}

void SpaceDefanseGameImpl::StrokeEllipse(Vec2 pos, float rx, float ry, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawEllipse(Ellipse(pos, rx, ry), m_brush.Get(), width);
}

void SpaceDefanseGameImpl::DrawLine(Vec2 a, Vec2 b, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawLine(Point(a), Point(b), m_brush.Get(), width, m_roundStroke.Get());
}

void SpaceDefanseGameImpl::DrawBitmap(ID2D1Bitmap* bitmap, D2D1_RECT_F destination, float opacity, const D2D1_RECT_F* source)
{
    if (!bitmap)
    {
        return;
...
void SpaceDefanseGameImpl::DrawWeaponBitmap(ID2D1Bitmap* bitmap, Vec2 center, float width, float height, float angleDegrees, float opacity, bool flipX)
{
...
void SpaceDefanseGameImpl::DrawBitmapCover(ID2D1Bitmap* bitmap, D2D1_RECT_F area, float opacity, float time, float cameraX, float motionScale)
{
...
void SpaceDefanseGameImpl::DrawString(const std::wstring& text, D2D1_RECT_F rect, IDWriteTextFormat* format, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->DrawTextW(text.c_str(), static_cast<UINT32>(text.size()), format, rect, m_brush.Get());
}

void SpaceDefanseGameImpl::DrawString(const std::wstring& text, D2D1_RECT_F rect, const Microsoft::WRL::ComPtr<IDWriteTextFormat>& format, D2D1_COLOR_F color)
{
    DrawString(text, rect, format.Get(), color);
}

void SpaceDefanseGameImpl::DrawOutlinedString(const std::wstring& text, D2D1_RECT_F rect, IDWriteTextFormat* format, D2D1_COLOR_F color, float outlineAlpha)
{
...
void SpaceDefanseGameImpl::DrawOutlinedString(const std::wstring& text, D2D1_RECT_F rect, const Microsoft::WRL::ComPtr<IDWriteTextFormat>& format, D2D1_COLOR_F color, float outlineAlpha)
{
    DrawOutlinedString(text, rect, format.Get(), color, outlineAlpha);
}

void SpaceDefanseGameImpl::DrawCartoonPanel(D2D1_RECT_F rect, D2D1_COLOR_F fill, D2D1_COLOR_F accent, bool hover)
{
...
void SpaceDefanseGameImpl::DrawBriefingPanel(D2D1_RECT_F rect, D2D1_COLOR_F fill, D2D1_COLOR_F accent, bool hover)
{
...
void SpaceDefanseGameImpl::DrawBriefingButton(D2D1_RECT_F rect, const std::wstring& label, bool enabled, D2D1_COLOR_F fill, bool active)
{
...
float SpaceDefanseGameImpl::PixelTextWidth(const std::wstring& text, float cell) const
{
    float width = 0.0f;
...
void SpaceDefanseGameImpl::DrawPixelText(const std::wstring& text, Vec2 pos, float cell, D2D1_COLOR_F color, float alpha, bool shadow)
{
    float cursor = pos.x;
...
void SpaceDefanseGameImpl::DrawPixelTextCentered(const std::wstring& text, D2D1_RECT_F rect, float cell, D2D1_COLOR_F color, float alpha)
{
...
Vec2 SpaceDefanseGameImpl::WorldToScreen(Vec2 pos) const
{
    return {pos.x - m_cameraX, pos.y};
}

D2D1_RECT_F SpaceDefanseGameImpl::WorldRect(float left, float top, float right, float bottom) const
{
    return D2D1::RectF(left - m_cameraX, top, right - m_cameraX, bottom);
}

void SpaceDefanseGameImpl::DrawVfxAtlasTile(int tileX, int tileY, Vec2 center, float size, float opacity)
{
    if (!m_vfxAtlas)
    {
        return;
...
void SpaceDefanseGameImpl::DrawImageVfxFrame(ImageVfxKind kind, int frame, Vec2 center, float size, float opacity)
{
...
void SpaceDefanseGameImpl::DrawImageVfxSprites()
{
...
void SpaceDefanseGameImpl::DrawUiPanelAsset(D2D1_RECT_F rect, int tileIndex, float opacity)
{
    if (!m_uiAtlas)
    {
        return;
...
void SpaceDefanseGameImpl::DrawPlayerIcon(PlayerUnit type, Vec2 center, float scale, bool enabled)
{
...
bool SpaceDefanseGameImpl::IsUnitInLoadout(PlayerUnit unit) const
{
...
void SpaceDefanseGameImpl::DrawSpaceDepthGrid(D2D1_RECT_F area, int stageIndex, float time, float cameraX)
{
...
void SpaceDefanseGameImpl::DrawDeepSpaceBackdrop(D2D1_RECT_F area, int stageIndex, float time, float cameraX, bool showRoute)
{
...
void SpaceDefanseGameImpl::DrawTitle()
{
...
void SpaceDefanseGameImpl::DrawStoryCrawl()
{
...
void SpaceDefanseGameImpl::DrawEndingScene()
{
...
void SpaceDefanseGameImpl::DrawOptions()
{
...
void SpaceDefanseGameImpl::DrawMenu()
{
...
void SpaceDefanseGameImpl::DrawArchive()
{
    DrawDeepSpaceBackdrop(D2D1::RectF(0.0f, 0.0f, kWidth, kHeight), m_selectedStage, m_uiTime, 0.0f, false);
...
void SpaceDefanseGameImpl::DrawBriefing()
{
...
void SpaceDefanseGameImpl::DrawShop()
{
    DrawDeepSpaceBackdrop(D2D1::RectF(0.0f, 0.0f, kWidth, kHeight), m_selectedStage, m_uiTime, 0.0f, false);
    for (float y = 30.0f; y < kHeight; y += 44.0f)
    {
...
void SpaceDefanseGameImpl::DrawShopUnitCard(int index)
{
...
void SpaceDefanseGameImpl::DrawSynergyPanel(D2D1_RECT_F rect)
{
...
void SpaceDefanseGameImpl::DrawBalancePanel(D2D1_RECT_F rect)
{
...
void SpaceDefanseGameImpl::DrawShopUnitDetail()
{
...
void SpaceDefanseGameImpl::DrawStageCard(int index)
{
...
void SpaceDefanseGameImpl::DrawLoadoutSlot(int index)
{
...
void SpaceDefanseGameImpl::DrawRosterCard(int index)
{
    const PlayerUnit unit = static_cast<PlayerUnit>(index);
    const UnitStats stats = PlayerStats(unit);
...
void SpaceDefanseGameImpl::DrawArena()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefanseGameImpl::DrawSpaceBackdrop()
{
...
void SpaceDefanseGameImpl::DrawCrater(Vec2 center, float rx, float ry, D2D1_COLOR_F rim, D2D1_COLOR_F shade)
{
...
void SpaceDefanseGameImpl::DrawCloudCluster(Vec2 center, float scale, D2D1_COLOR_F color)
{
...
void SpaceDefanseGameImpl::DrawStageDecorations()
{
...
void SpaceDefanseGameImpl::DrawLongRangeDecorations()
{
...
void SpaceDefanseGameImpl::DrawStageLanePattern()
{
    switch (m_selectedStage)
    {
    case 0:
...
void SpaceDefanseGameImpl::DrawBases()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefanseGameImpl::DrawBaseHp(Vec2 base, float hp, float maxHp, D2D1_COLOR_F color)
{
...
Vec2 SpaceDefanseGameImpl::StageLightDirection() const
{
...
float SpaceDefanseGameImpl::UnitShadowLift(const Unit& unit) const
{
...
void SpaceDefanseGameImpl::DrawUnitLighting()
{
...
void SpaceDefanseGameImpl::DrawUnits()
{
    m_drawOrder.clear();
...
float SpaceDefanseGameImpl::AttackProgress(const Unit& unit) const
{
...
float SpaceDefanseGameImpl::AttackIntensity(const Unit& unit) const
{
    if (unit.attackAnim <= 0.0f || unit.attackAnimMax <= 0.0f)
    {
        return 0.0f;
...
float SpaceDefanseGameImpl::AttackWindup(const Unit& unit) const
{
...
float SpaceDefanseGameImpl::AttackStrike(const Unit& unit) const
{
    const float p = AttackProgress(unit);
...
float SpaceDefanseGameImpl::AttackRecoil(const Unit& unit) const
{
    const float p = AttackProgress(unit);
    if (p <= 0.58f || p >= 1.0f)
    {
...
float SpaceDefanseGameImpl::AttackLungeDistance(const Unit& unit) const
{
    if (unit.team == Team::Player)
    {
        switch (static_cast<PlayerUnit>(unit.kind))
...
Vec2 SpaceDefanseGameImpl::UnitRenderPos(const Unit& unit) const
{
    Vec2 pos = unit.pos;
...
void SpaceDefanseGameImpl::DrawUnitActionLines(const Unit& unit, Vec2 pos, D2D1_COLOR_F accent)
{
    if (unit.attackAnim <= 0.0f || unit.attackAnimMax <= 0.0f)
    {
        return;
...
void SpaceDefanseGameImpl::DrawPlayerWeapon(const Unit& unit, Vec2 pos, const UnitStats& stats, float windup, float strike, float recoil)
{
...
void SpaceDefanseGameImpl::DrawEnemyWeapon(const Unit& unit, Vec2 pos, const UnitStats& stats, float windup, float strike, float recoil)
{
...
void SpaceDefanseGameImpl::DrawUnitIdentityMark(const Unit& unit, Vec2 pos, D2D1_COLOR_F accent)
{
    const float attack = AttackIntensity(unit);
...
bool SpaceDefanseGameImpl::DrawUnitCharacterSprite(const Unit& unit, Vec2 pos, D2D1_COLOR_F accent)
{
...
void SpaceDefanseGameImpl::DrawPlayerUnit(const Unit& unit)
{
...
void SpaceDefanseGameImpl::DrawEnemyUnit(const Unit& unit)
{
    const EnemyUnit type = static_cast<EnemyUnit>(unit.kind);
...
void SpaceDefanseGameImpl::DrawUnitHp(const Unit& unit)
{
    const Vec2 pos = UnitRenderPos(unit);
...
void SpaceDefanseGameImpl::DrawUnitStunEffect(const Unit& unit)
{
...
void SpaceDefanseGameImpl::DrawProjectiles()
{
...
void SpaceDefanseGameImpl::DrawProjectileShape(const Projectile& projectile, Vec2 drawPos, Vec2 dir, Vec2 normal, float pulse)
{
...
void SpaceDefanseGameImpl::DrawBeams()
{
...
void SpaceDefanseGameImpl::DrawSparkLines()
{
...
void SpaceDefanseGameImpl::DrawRings()
{
    const bool cameraCull = m_screen == GameScreen::Playing || m_screen == GameScreen::Result;
...
void SpaceDefanseGameImpl::DrawParticles()
{
    const bool cameraCull = m_screen == GameScreen::Playing || m_screen == GameScreen::Result;
...
void SpaceDefanseGameImpl::DrawShaderPostProcess()
{
    // This mirrors shaders/space_defanse_vfx.hlsl using Direct2D primitives. Combat
...
void SpaceDefanseGameImpl::DrawScreenFlash()
{
...
void SpaceDefanseGameImpl::DrawFloatTexts()
{
    const bool cameraCull = m_screen == GameScreen::Playing || m_screen == GameScreen::Result;
...
void SpaceDefanseGameImpl::DrawUiPulses()
{
...
void SpaceDefanseGameImpl::DrawTelegraphs()
{
...
void SpaceDefanseGameImpl::DrawStageGimmickOverlay()
{
...
void SpaceDefanseGameImpl::DrawBossPresentation()
{
    if (m_screen != GameScreen::Playing && m_screen != GameScreen::Result)
    {
        return;
...
void SpaceDefanseGameImpl::DrawTutorialTips()
{
...
void SpaceDefanseGameImpl::DrawShowcaseBadge()
{
...
std::wstring SpaceDefanseGameImpl::DemoStepText() const
{
...
void SpaceDefanseGameImpl::DrawDebugBadge()
{
    if (!m_debugMode)
    {
        return;
...
void SpaceDefanseGameImpl::DrawBattleLogo()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefanseGameImpl::DrawHeader()
{
    const StageDefinition stage = CurrentStage();
    DrawBattleLogo();
...
void SpaceDefanseGameImpl::DrawCameraHud()
{
    if (m_screen != GameScreen::Playing && m_screen != GameScreen::Result)
    {
        return;
...
void SpaceDefanseGameImpl::DrawTopStat(float x, const std::wstring& label, const std::wstring& value, D2D1_COLOR_F color)
{
...
void SpaceDefanseGameImpl::DrawCommandBar()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefanseGameImpl::DrawFullscreenFrameExtensions()
{
    if (!m_renderTarget)
    {
        return;
...
void SpaceDefanseGameImpl::DrawCombatHelpPanel()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefanseGameImpl::DrawUnitCard(int index)
{
...
void SpaceDefanseGameImpl::DrawWalletButton()
{
...
void SpaceDefanseGameImpl::DrawCannonButton()
{
...
void SpaceDefanseGameImpl::DrawButton(D2D1_RECT_F rect, const std::wstring& label, bool enabled, D2D1_COLOR_F fill)
{
    const bool hover = Contains(rect, m_mouse);
    D2D1_COLOR_F actualFill = enabled ? fill : D2D1::ColorF(0x171D23);
    if (hover && enabled)
...
void SpaceDefanseGameImpl::DrawMessage()
{
...
void SpaceDefanseGameImpl::DrawOverlay()
{
...
void SpaceDefanseGameImpl::DrawSceneTransition()
{
...
void SpaceDefanseGameImpl::DrawEscapeMenuClean()
{
...
void SpaceDefanseGameImpl::DrawResultScreen()
{
...
void SpaceDefanseGameImpl::DrawFinalClearScene(D2D1_RECT_F panel)
{

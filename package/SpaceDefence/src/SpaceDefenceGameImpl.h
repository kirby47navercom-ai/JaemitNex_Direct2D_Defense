...
// SpaceDefenceGameImpl*.cpp files. Keeping them here lets combat, input, and render
...
public:
    ...
    SpaceDefenceGameImpl() = default;

    ~SpaceDefenceGameImpl();
...
private:
    ...
    // across SpaceDefenceGameImplCore/Combat/Input/Layout/Render.cpp.

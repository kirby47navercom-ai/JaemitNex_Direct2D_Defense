...
void SpaceDefenceGameImpl::Render()
{
...
void SpaceDefenceGameImpl::SetColor(D2D1_COLOR_F color)
{
    m_brush->SetColor(color);
}

void SpaceDefenceGameImpl::FillRect(D2D1_RECT_F rect, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->FillRectangle(rect, m_brush.Get());
}

void SpaceDefenceGameImpl::StrokeRect(D2D1_RECT_F rect, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawRectangle(rect, m_brush.Get(), width);
}

D2D1_RECT_F SpaceDefenceGameImpl::FullViewportRect() const
{
    if (!m_renderTarget)
    {
...
void SpaceDefenceGameImpl::FillViewport(D2D1_COLOR_F color)
{
    if (!m_renderTarget)
    {
        return;
...
void SpaceDefenceGameImpl::FillRoundRect(D2D1_RECT_F rect, float radius, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->FillRoundedRectangle(D2D1::RoundedRect(rect, radius, radius), m_brush.Get());
}

void SpaceDefenceGameImpl::StrokeRoundRect(D2D1_RECT_F rect, float radius, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawRoundedRectangle(D2D1::RoundedRect(rect, radius, radius), m_brush.Get(), width);
}

void SpaceDefenceGameImpl::FillEllipse(Vec2 pos, float rx, float ry, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->FillEllipse(Ellipse(pos, rx, ry), m_brush.Get());
}

void SpaceDefenceGameImpl::StrokeEllipse(Vec2 pos, float rx, float ry, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawEllipse(Ellipse(pos, rx, ry), m_brush.Get(), width);
}

void SpaceDefenceGameImpl::DrawLine(Vec2 a, Vec2 b, D2D1_COLOR_F color, float width)
{
    SetColor(color);
    m_renderTarget->DrawLine(Point(a), Point(b), m_brush.Get(), width, m_roundStroke.Get());
}

void SpaceDefenceGameImpl::DrawBitmap(ID2D1Bitmap* bitmap, D2D1_RECT_F destination, float opacity, const D2D1_RECT_F* source)
{
    if (!bitmap)
    {
        return;
...
void SpaceDefenceGameImpl::DrawWeaponBitmap(ID2D1Bitmap* bitmap, Vec2 center, float width, float height, float angleDegrees, float opacity, bool flipX)
{
...
void SpaceDefenceGameImpl::DrawBitmapCover(ID2D1Bitmap* bitmap, D2D1_RECT_F area, float opacity, float time, float cameraX, float motionScale)
{
...
void SpaceDefenceGameImpl::DrawString(const std::wstring& text, D2D1_RECT_F rect, IDWriteTextFormat* format, D2D1_COLOR_F color)
{
    SetColor(color);
    m_renderTarget->DrawTextW(text.c_str(), static_cast<UINT32>(text.size()), format, rect, m_brush.Get());
}

void SpaceDefenceGameImpl::DrawString(const std::wstring& text, D2D1_RECT_F rect, const Microsoft::WRL::ComPtr<IDWriteTextFormat>& format, D2D1_COLOR_F color)
{
    DrawString(text, rect, format.Get(), color);
}

void SpaceDefenceGameImpl::DrawOutlinedString(const std::wstring& text, D2D1_RECT_F rect, IDWriteTextFormat* format, D2D1_COLOR_F color, float outlineAlpha)
{
...
void SpaceDefenceGameImpl::DrawOutlinedString(const std::wstring& text, D2D1_RECT_F rect, const Microsoft::WRL::ComPtr<IDWriteTextFormat>& format, D2D1_COLOR_F color, float outlineAlpha)
{
    DrawOutlinedString(text, rect, format.Get(), color, outlineAlpha);
}

void SpaceDefenceGameImpl::DrawCartoonPanel(D2D1_RECT_F rect, D2D1_COLOR_F fill, D2D1_COLOR_F accent, bool hover)
{
...
void SpaceDefenceGameImpl::DrawBriefingPanel(D2D1_RECT_F rect, D2D1_COLOR_F fill, D2D1_COLOR_F accent, bool hover)
{
...
void SpaceDefenceGameImpl::DrawBriefingButton(D2D1_RECT_F rect, const std::wstring& label, bool enabled, D2D1_COLOR_F fill, bool active)
{
...
float SpaceDefenceGameImpl::PixelTextWidth(const std::wstring& text, float cell) const
{
    float width = 0.0f;
...
void SpaceDefenceGameImpl::DrawPixelText(const std::wstring& text, Vec2 pos, float cell, D2D1_COLOR_F color, float alpha, bool shadow)
{
    float cursor = pos.x;
...
void SpaceDefenceGameImpl::DrawPixelTextCentered(const std::wstring& text, D2D1_RECT_F rect, float cell, D2D1_COLOR_F color, float alpha)
{
...
Vec2 SpaceDefenceGameImpl::WorldToScreen(Vec2 pos) const
{
    return {pos.x - m_cameraX, pos.y};
}

D2D1_RECT_F SpaceDefenceGameImpl::WorldRect(float left, float top, float right, float bottom) const
{
    return D2D1::RectF(left - m_cameraX, top, right - m_cameraX, bottom);
}

void SpaceDefenceGameImpl::DrawVfxAtlasTile(int tileX, int tileY, Vec2 center, float size, float opacity)
{
    if (!m_vfxAtlas)
    {
        return;
...
void SpaceDefenceGameImpl::DrawImageVfxFrame(ImageVfxKind kind, int frame, Vec2 center, float size, float opacity)
{
...
void SpaceDefenceGameImpl::DrawImageVfxSprites()
{
...
void SpaceDefenceGameImpl::DrawUiPanelAsset(D2D1_RECT_F rect, int tileIndex, float opacity)
{
    if (!m_uiAtlas)
    {
        return;
...
void SpaceDefenceGameImpl::DrawPlayerIcon(PlayerUnit type, Vec2 center, float scale, bool enabled)
{
...
bool SpaceDefenceGameImpl::IsUnitInLoadout(PlayerUnit unit) const
{
...
void SpaceDefenceGameImpl::DrawSpaceDepthGrid(D2D1_RECT_F area, int stageIndex, float time, float cameraX)
{
...
void SpaceDefenceGameImpl::DrawDeepSpaceBackdrop(D2D1_RECT_F area, int stageIndex, float time, float cameraX, bool showRoute)
{
...
void SpaceDefenceGameImpl::DrawTitle()
{
    ...
    DrawPixelTextCentered(L"SPACE DEFENCE", D2D1::RectF(166.0f, 350.0f, 1114.0f, 424.0f), 6.2f, D2D1::ColorF(0xF3FBFF), 1.0f);
...
void SpaceDefenceGameImpl::DrawStoryCrawl()
{
    ...
    DrawPixelTextCentered(L"SPACE DEFENCE", D2D1::RectF(210.0f, 118.0f, 1070.0f, 168.0f), 4.0f, D2D1::ColorF(0xCFE8F5), titleFade);
...
void SpaceDefenceGameImpl::DrawEndingScene()
{
...
void SpaceDefenceGameImpl::DrawOptions()
{
...
void SpaceDefenceGameImpl::DrawMenu()
{
    ...
    DrawPixelText(L"SPACE DEFENCE", {48.0f, 42.0f}, 4.2f, D2D1::ColorF(0xF3FBFF));
...
void SpaceDefenceGameImpl::DrawArchive()
{
    DrawDeepSpaceBackdrop(D2D1::RectF(0.0f, 0.0f, kWidth, kHeight), m_selectedStage, m_uiTime, 0.0f, false);
...
void SpaceDefenceGameImpl::DrawBriefing()
{
...
void SpaceDefenceGameImpl::DrawShop()
{
    DrawDeepSpaceBackdrop(D2D1::RectF(0.0f, 0.0f, kWidth, kHeight), m_selectedStage, m_uiTime, 0.0f, false);
    for (float y = 30.0f; y < kHeight; y += 44.0f)
    {
...
void SpaceDefenceGameImpl::DrawShopUnitCard(int index)
{
...
void SpaceDefenceGameImpl::DrawSynergyPanel(D2D1_RECT_F rect)
{
...
void SpaceDefenceGameImpl::DrawBalancePanel(D2D1_RECT_F rect)
{
...
void SpaceDefenceGameImpl::DrawShopUnitDetail()
{
...
void SpaceDefenceGameImpl::DrawStageCard(int index)
{
...
void SpaceDefenceGameImpl::DrawLoadoutSlot(int index)
{
...
void SpaceDefenceGameImpl::DrawRosterCard(int index)
{
    const PlayerUnit unit = static_cast<PlayerUnit>(index);
    const UnitStats stats = PlayerStats(unit);
...
void SpaceDefenceGameImpl::DrawArena()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefenceGameImpl::DrawSpaceBackdrop()
{
...
void SpaceDefenceGameImpl::DrawCrater(Vec2 center, float rx, float ry, D2D1_COLOR_F rim, D2D1_COLOR_F shade)
{
...
void SpaceDefenceGameImpl::DrawCloudCluster(Vec2 center, float scale, D2D1_COLOR_F color)
{
...
void SpaceDefenceGameImpl::DrawStageDecorations()
{
...
void SpaceDefenceGameImpl::DrawLongRangeDecorations()
{
...
void SpaceDefenceGameImpl::DrawStageLanePattern()
{
    switch (m_selectedStage)
    {
    case 0:
...
void SpaceDefenceGameImpl::DrawBases()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefenceGameImpl::DrawBaseHp(Vec2 base, float hp, float maxHp, D2D1_COLOR_F color)
{
...
Vec2 SpaceDefenceGameImpl::StageLightDirection() const
{
...
float SpaceDefenceGameImpl::UnitShadowLift(const Unit& unit) const
{
...
void SpaceDefenceGameImpl::DrawUnitLighting()
{
...
void SpaceDefenceGameImpl::DrawUnits()
{
    m_drawOrder.clear();
...
float SpaceDefenceGameImpl::AttackProgress(const Unit& unit) const
{
...
float SpaceDefenceGameImpl::AttackIntensity(const Unit& unit) const
{
    if (unit.attackAnim <= 0.0f || unit.attackAnimMax <= 0.0f)
    {
        return 0.0f;
...
float SpaceDefenceGameImpl::AttackWindup(const Unit& unit) const
{
...
float SpaceDefenceGameImpl::AttackStrike(const Unit& unit) const
{
    const float p = AttackProgress(unit);
...
float SpaceDefenceGameImpl::AttackRecoil(const Unit& unit) const
{
    const float p = AttackProgress(unit);
    if (p <= 0.58f || p >= 1.0f)
    {
...
float SpaceDefenceGameImpl::AttackLungeDistance(const Unit& unit) const
{
    if (unit.team == Team::Player)
    {
        switch (static_cast<PlayerUnit>(unit.kind))
...
Vec2 SpaceDefenceGameImpl::UnitRenderPos(const Unit& unit) const
{
    Vec2 pos = unit.pos;
...
void SpaceDefenceGameImpl::DrawUnitActionLines(const Unit& unit, Vec2 pos, D2D1_COLOR_F accent)
{
    if (unit.attackAnim <= 0.0f || unit.attackAnimMax <= 0.0f)
    {
        return;
...
void SpaceDefenceGameImpl::DrawPlayerWeapon(const Unit& unit, Vec2 pos, const UnitStats& stats, float windup, float strike, float recoil)
{
...
void SpaceDefenceGameImpl::DrawEnemyWeapon(const Unit& unit, Vec2 pos, const UnitStats& stats, float windup, float strike, float recoil)
{
...
void SpaceDefenceGameImpl::DrawUnitIdentityMark(const Unit& unit, Vec2 pos, D2D1_COLOR_F accent)
{
    const float attack = AttackIntensity(unit);
...
bool SpaceDefenceGameImpl::DrawUnitCharacterSprite(const Unit& unit, Vec2 pos, D2D1_COLOR_F accent)
{
...
void SpaceDefenceGameImpl::DrawPlayerUnit(const Unit& unit)
{
...
void SpaceDefenceGameImpl::DrawEnemyUnit(const Unit& unit)
{
    const EnemyUnit type = static_cast<EnemyUnit>(unit.kind);
...
void SpaceDefenceGameImpl::DrawUnitHp(const Unit& unit)
{
    const Vec2 pos = UnitRenderPos(unit);
...
void SpaceDefenceGameImpl::DrawUnitStunEffect(const Unit& unit)
{
...
void SpaceDefenceGameImpl::DrawProjectiles()
{
...
void SpaceDefenceGameImpl::DrawProjectileShape(const Projectile& projectile, Vec2 drawPos, Vec2 dir, Vec2 normal, float pulse)
{
...
void SpaceDefenceGameImpl::DrawBeams()
{
...
void SpaceDefenceGameImpl::DrawSparkLines()
{
...
void SpaceDefenceGameImpl::DrawRings()
{
    const bool cameraCull = m_screen == GameScreen::Playing || m_screen == GameScreen::Result;
...
void SpaceDefenceGameImpl::DrawParticles()
{
    const bool cameraCull = m_screen == GameScreen::Playing || m_screen == GameScreen::Result;
...
void SpaceDefenceGameImpl::DrawShaderPostProcess()
{
    // This mirrors shaders/space_defence_vfx.hlsl using Direct2D primitives. Combat
...
void SpaceDefenceGameImpl::DrawScreenFlash()
{
...
void SpaceDefenceGameImpl::DrawFloatTexts()
{
    const bool cameraCull = m_screen == GameScreen::Playing || m_screen == GameScreen::Result;
...
void SpaceDefenceGameImpl::DrawUiPulses()
{
...
void SpaceDefenceGameImpl::DrawTelegraphs()
{
...
void SpaceDefenceGameImpl::DrawStageGimmickOverlay()
{
...
void SpaceDefenceGameImpl::DrawBossPresentation()
{
    if (m_screen != GameScreen::Playing && m_screen != GameScreen::Result)
    {
        return;
...
void SpaceDefenceGameImpl::DrawTutorialTips()
{
...
void SpaceDefenceGameImpl::DrawShowcaseBadge()
{
...
std::wstring SpaceDefenceGameImpl::DemoStepText() const
{
...
void SpaceDefenceGameImpl::DrawDebugBadge()
{
    if (!m_debugMode)
    {
        return;
...
void SpaceDefenceGameImpl::DrawBattleLogo()
{
    const StageDefinition stage = CurrentStage();
    ...
    drawWord(L"DEFENCE", {122.0f, 66.0f}, 2.45f, D2D1::ColorF(stage.lineColor.r, stage.lineColor.g, stage.lineColor.b, 0.98f));
    DrawLine({348.0f, 67.0f}, {422.0f, 67.0f}, D2D1::ColorF(stage.lineColor.r, stage.lineColor.g, stage.lineColor.b, 0.60f), 2.4f);
}

void SpaceDefenceGameImpl::DrawHeader()
{
    const StageDefinition stage = CurrentStage();
    DrawBattleLogo();
...
void SpaceDefenceGameImpl::DrawCameraHud()
{
    if (m_screen != GameScreen::Playing && m_screen != GameScreen::Result)
    {
        return;
...
void SpaceDefenceGameImpl::DrawTopStat(float x, const std::wstring& label, const std::wstring& value, D2D1_COLOR_F color)
{
...
void SpaceDefenceGameImpl::DrawCommandBar()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefenceGameImpl::DrawFullscreenFrameExtensions()
{
    if (!m_renderTarget)
    {
        return;
...
void SpaceDefenceGameImpl::DrawCombatHelpPanel()
{
    const StageDefinition stage = CurrentStage();
...
void SpaceDefenceGameImpl::DrawUnitCard(int index)
{
...
void SpaceDefenceGameImpl::DrawWalletButton()
{
...
void SpaceDefenceGameImpl::DrawCannonButton()
{
...
void SpaceDefenceGameImpl::DrawButton(D2D1_RECT_F rect, const std::wstring& label, bool enabled, D2D1_COLOR_F fill)
{
    const bool hover = Contains(rect, m_mouse);
    D2D1_COLOR_F actualFill = enabled ? fill : D2D1::ColorF(0x171D23);
    if (hover && enabled)
...
void SpaceDefenceGameImpl::DrawMessage()
{
...
void SpaceDefenceGameImpl::DrawOverlay()
{
...
void SpaceDefenceGameImpl::DrawSceneTransition()
{
...
void SpaceDefenceGameImpl::DrawEscapeMenuClean()
{
...
void SpaceDefenceGameImpl::DrawResultScreen()
{
...
void SpaceDefenceGameImpl::DrawFinalClearScene(D2D1_RECT_F panel)
{

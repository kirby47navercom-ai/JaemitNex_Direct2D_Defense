...
// SpaceDefanseGameImpl*.cpp files. Keeping them here lets combat, input, and render
...
public:
    ...
    SpaceDefanseGameImpl() = default;

    ~SpaceDefanseGameImpl();
...
private:
    ...
    // across SpaceDefanseGameImplCore/Combat/Input/Layout/Render.cpp.
